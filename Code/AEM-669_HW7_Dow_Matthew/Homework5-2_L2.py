...
#            show_bodies=True,show_ZVC=True,xlimits=(1,1.2),ylimits=(-0.2,.2))
...
#            show_bodies=True,show_ZVC=False,xlimits=(1,1.2),ylimits=(-0.2,.2),names=range(i))
...
# extract real part 
real0 = [ele[0].real for ele in overall_eigsvec] 
real1 = [ele[1].real for ele in overall_eigsvec] 
real2 = [ele[2].real for ele in overall_eigsvec] 
real3 = [ele[3].real for ele in overall_eigsvec] 
# extract imaginary part 
im0 = [ele[0].imag for ele in overall_eigsvec] 
im1 = [ele[1].imag for ele in overall_eigsvec] 
im2 = [ele[2].imag for ele in overall_eigsvec] 
im3 = [ele[3].imag for ele in overall_eigsvec] 
