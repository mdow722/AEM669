...
from ThreeBodyModel import GetJacobiConstant,GetZVCGrid_xy
import numpy as np

def Plot_CR3BP(vector_of_trajectories,mu,title_string="",show_initial_pos=True,show_final_pos=True,show_bodies=True,show_ZVC=True,xlimits=(-1.5,1.5),ylimits=(-1.5,1.5),names=None):
...
def Plot_CR3BP_3D(vector_of_trajectories,mu,title_string="",show_initial_pos=True,show_final_pos=True,show_bodies=True,show_ZVC=True,xlimits=(-1.5,1.5),ylimits=(-1.5,1.5),names=None):
