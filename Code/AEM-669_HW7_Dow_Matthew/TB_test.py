...
# Amatrix = GetAMatrix_CR3BP([xLib[0],0,0],mu,dim=2)
# eigs = GetEigenvalues(Amatrix)
# print(eigs)
# l3 = eigs[2]
# x0dev = 0.01
...
# Xgrid2,Ygrid2,Zgrid2 = GetZVCGrid_xy(mu,jacobi_c2c,resolution=0.001)
...
# print("jacobi_c2c",jacobi_c2c)
# # print(jacobi_c2c-jacobi_constant)
# Xgrid3,Ygrid3,Zgrid3 = GetZVCGrid_xy(mu,jacobi_c2c,resolution=0.001)
...
# print(jacobi_c2c-jacobi_constant)
# Xgrid3,Ygrid3,Zgrid3 = GetZVCGrid_xy(mu,jacobi_c3g,resolution=0.001)
